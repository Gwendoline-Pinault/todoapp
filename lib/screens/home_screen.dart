              ...
              child: Column(
                children: [
                      ...
                      Expanded(child: 
                        Center(child: 
                          SegmentedButton(
                            ...
                            selected: <Prio>{prioFilter},
                            onSelectionChanged: (Set<Prio> selection) {
                              setState(() {
                                prioFilter = selection.first;
                              });
                            }
                          ),
                        )
                  ...
                  StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance.collection('users/$userId/tasks').where('priority').snapshots(),
